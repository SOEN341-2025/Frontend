...
import { Fa500Px, FaInstagram, FaLinkedin } from "react-icons/fa";
...
export default function Footer() {
  ...
  return (
    <footer className="footer">
      ...
      <h4 id="contact-heading">Let's connect</h4>

      <div className="socials-container">
        <a style={{"--accent-color": '#fe107c'}} href="https://www.instagram.com/concordiauniversity/">
        ...
        <a style={{"--accent-color": 'black'}}href="https://x.com/concordia">
        ...
        <a style={{"--accent-color": 'red'}}href="https://www.youtube.com/@concordiauniversitymontreal">
      ...
      <hr/>
      <p className="footerBottom">Service available in English and French.</p>

      <p>
        <span className="footer-bottom-left-content">We respect your privacy and only use your info to help with your request.</span>
        <span className="footer-bottom-right-content">&copy; Campus Events. All rights reserved.</span>
      </p>
